...
final class ResponseTypeCoercerTest extends TestCase
{
    ...
    public function coerce_string_to_integer_with_exponential_notation_returns_string_as_is(): void
    {
        ...
        $result = $this->coercer->coerce('1e10', new CoercionContext(schema: $schema, enabled: true, strict: false));
    ...
    public function coerce_string_to_integer_with_hex_notation_returns_string_as_is(): void
    {
        ...
        $result = $this->coercer->coerce('0x10', new CoercionContext(schema: $schema, enabled: true, strict: false));
    ...
    public function coerce_empty_string_to_integer_returns_string_as_is(): void
    {
        ...
        $result = $this->coercer->coerce('', new CoercionContext(schema: $schema, enabled: true, strict: false));
    ...
    public function coerce_float_string_to_integer_returns_string_as_is(): void
    {
        ...
        $result = $this->coercer->coerce('123.45', new CoercionContext(schema: $schema, enabled: true, strict: false));
    ...
    public function coerce_non_boolean_string_to_boolean(): void
    {
        ...
        $result = $this->coercer->coerce('random', new CoercionContext(schema: $schema, enabled: true, strict: false));
    ...
    public function return_coerced_value_when_union_type_matches_boolean(): void
    {
        ...
        $result = $this->coercer->coerce('value', new CoercionContext(schema: $schema, enabled: true, strict: false));
    ...
    public function return_boolean_when_union_type_integer_fails_for_non_integer_string(): void
    {
        ...
        $result = $this->coercer->coerce('abc', new CoercionContext(schema: $schema, enabled: true, strict: false));
    ...
    public function coerce_number_string_to_boolean_false(): void
    {
        ...
        $result = $this->coercer->coerce('2', new CoercionContext(schema: $schema, enabled: true, strict: false));
    ...
    #[Test]
    public function coerce_to_array_processes_items_response(): void
    {
        $schema = new Schema(
            type: 'array',
    ...
    #[Test]
    public function coerce_object_only_defined_properties_get_coerced(): void
    {
        $schema = new Schema(
            type: 'object',
            properties: [
    ...
    public function coerce_float_to_integer_returns_float_as_is_when_fractional(): void
    {
        ...
        $result = $this->coercer->coerce(42.5, new CoercionContext(schema: $schema, enabled: true, strict: false));
    ...
    #[Test]
    public function coerce_to_array_returns_non_array_as_is_response(): void
    {
    ...
    #[Test]
    public function coerce_to_object_preserves_additional_properties_response(): void
    {
        $schema = new Schema(
            type: 'object',
            properties: [
    ...
    #[Test]
    public function coerce_to_object_preserves_null_property_value_response(): void
    {
        $schema = new Schema(
            type: 'object',
            properties: [
