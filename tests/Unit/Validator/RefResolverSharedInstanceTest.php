...
YAML;
    ...
    private static function readRequestBodyRefResolver(OpenApiValidator $validator): RefResolver
    {
        ...
        $requestValidator = self::readProperty($context, ValidatorDependencies::class, 'requestValidator');
    ...
    private static function readResponseRefResolver(OpenApiValidator $validator): RefResolver
    {
        ...
        $responseValidator = self::readProperty($context, ValidatorDependencies::class, 'responseValidator');
